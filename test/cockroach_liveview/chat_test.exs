defmodule CockroachLiveview.ChatTest do
  use CockroachLiveview.DataCase

  alias CockroachLiveview.Chat
  ...
  describe "chat_conversation_members" do
    alias CockroachLiveview.Chat.ConversationMember
  ...
  describe "chat_emojis" do
    alias CockroachLiveview.Chat.Emoji
  ...
  describe "chat_message_reactions" do
    alias CockroachLiveview.Chat.MessageReaction
  ...
  describe "chat_seen_messages" do
    alias CockroachLiveview.Chat.SeenMessage
